...
- **Assets in release**: 1
- **Published**: 2026-02-25T01:10:06Z

## Popularity

- **Stars**: 10,226 · **Forks**: 875 · **Open issues**: 4,664 · **Contributors**: 387
...
- **Edit the package entry**: <https://github.com/x-cmd/edit/main/lutris.yml> (or whichever path the index uses)
